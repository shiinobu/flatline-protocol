...
export const M02_WORKSTATION_ROUTER_IP = "66.0.34.202";
...
export const M02_DEPLOY_LOG_CONTENT = [
    ...
    "2024-03-11 09:15 UTC — payout paperwork archived to personal workstation (203.0.113.142) per usual, don't leave it on the panel server.",
].join("\n");
...
export const M02_OBJECTIVE_IDS = {
    ...
    rootgrabWorkstation: "m02.objective.04",
    downloadFinancialDoc: "m02.objective.05",
    reportFindings: "m02.objective.06",
} as const;
...
export const M02_OBJECTIVES: QuestObjectiveDefinition[] = [
    ...
    },
    {
        ...
        hint: "nmap needs the -sV flag once you find the dev server — a bare scan won't cut it.",
